# grfiv/cuda_theano_nolearn Docker Hub repo   
   
Based on **kaixhin/cuda-theano**, this repo adds lasagna and nolearn

---------------------

# the kaixhin/cuda-theano README as of December 2016

cuda-theano
Ubuntu Core 14.04 + CUDA 8.0 + cuDNN v5 + Theano.

Requirements
[NVIDIA Docker](https://github.com/NVIDIA/nvidia-docker) - see requirements for more details.
Usage
Use NVIDIA Docker: 
